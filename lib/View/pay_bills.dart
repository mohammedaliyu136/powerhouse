...
import 'package:power_house/View/billing_page.dart';

class PayBillsPage extends StatefulWidget {
  PayBillsPage({Key key}) : super(key: key);

  @override
  _PayBillsPageState createState() {
    return _PayBillsPageState();
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.transparent,elevation: 0, title: Text("Pay bills", style: TextStyle(color: Colors.black),),centerTitle: true,),
      body: Padding(
